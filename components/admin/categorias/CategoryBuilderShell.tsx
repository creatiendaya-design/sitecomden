...
export function CategoryBuilderShell({
  ...
  // Plan 18 — see PageBuilderShell for the rationale on this serialization
  // pattern. Same self-conflict race applies here.
  ...
  const performSave = useCallback(
    ...
    [category.id, replaceBlocksFromServer],
  )
