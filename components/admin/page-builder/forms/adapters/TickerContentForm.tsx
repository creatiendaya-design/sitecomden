...
const TickerBlockForm = dynamic(
  () => import("@/components/admin/landing-builder/block-forms/TickerBlockForm"),
...
export function TickerContentForm({ content, onChange }: Props) {
  return (
    <TickerBlockForm
